...
Nostr (`kind:3434` events, NIP-44 v2 end-to-end encryption). The wire protocol is specified in
...
subscriptions filter on `kinds:[3434]` + `#p` (recipient pseudonym pubkeys).
